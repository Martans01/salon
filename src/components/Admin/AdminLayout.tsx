...
const navItems = [
  ...
  ...(hasMultipleBarbers ? [{ href: '/admin/barberos', label: 'Barberos', icon: 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-2a4 4 0 11-8 0 4 4 0 018 0zm6-3a3 3 0 11-6 0 3 3 0 016 0z' }] : []),
